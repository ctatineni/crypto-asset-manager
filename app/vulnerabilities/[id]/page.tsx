  ...
  return (
    <div className="container max-w-7xl mx-auto">
      <div className="flex items-center mb-6">
        ...
        <div>
          <h1 className="text-3xl font-bold text-slate-900 dark:text-white">{vulnerability.name}</h1>
        ...
        <div className="col-span-2 space-y-6">
                  ...
                  <div className="mt-1 p-4 bg-slate-100 dark:bg-slate-800 rounded-md font-mono text-sm">
                    {vulnerability.name === "Expired Certificate" ? (
                      <>
                        ...
                        <br />
                        Expiration: 2023-04-15T23:59:59Z
                        <br />
                        Current date: 2023-05-03T14:50:00Z
                        <br />
                      ...
                      <>
                        Algorithm: MD5
                        <br />
                        Current usage: Password hashing
                        <br />
                        Problem: Cryptographically broken, vulnerable to collision attacks
                        <br />
                        NIST Recommendation: Use SHA-3, BLAKE2, or Argon2 instead
                      </>
                    ) : vulnerability.name === "Hardcoded API Keys" ? (
                      <>
                        Location: /src/api/client.js, line 42
                        <br />
                        Key type: AWS Secret Access Key
                        <br />
                        Exposure: Private repository, but embedded in compiled code
                        <br />
                        Risk: Credential exposure in distributed application
                      </>
                    ) : (
                      <>
                        Component: OpenSSL v1.0.2k
                        <br />
                        CVE: CVE-2023-0286, CVE-2022-3602
                        <br />
                        Impact: Remote code execution, TLS handshake vulnerability
                        <br />
                ...
                <div>
                  ...
                  <div className="mt-1 p-4 bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-md">
                    <div className="flex items-start mb-3">
                      <AlertTriangle
                        className={`h-5 w-5 mt-0.5 ${vulnerability.severity === "critical" ? "text-red-500" : "text-amber-500"}`}
                      />
                      <div className="ml-2">
                        <h4 className="font-medium">
                          Risk Level: {vulnerability.severity.charAt(0).toUpperCase() + vulnerability.severity.slice(1)}
                        </h4>
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-4">
                <div className="p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-md">
                  ...
                  <p className="text-sm text-blue-800 dark:text-blue-300 mt-1">{vulnerability.recommendation}</p>
                </div>
                        ...
                        {vulnerability.name === "Expired Certificate" ? (
                          ...
                          <>
                            <TableRow>
                              <TableCell>1</TableCell>
                              <TableCell>
                                Update authentication code to use bcrypt or Argon2 for password hashing
                              </TableCell>
                              <TableCell>
                                <Badge className="bg-red-500">Critical</Badge>
                              </TableCell>
                            ...
                            <TableRow>
                              <TableCell>2</TableCell>
                              <TableCell>
                                Create a migration script to rehash existing passwords when users log in
                              </TableCell>
                              <TableCell>
                                <Badge className="bg-amber-500">High</Badge>
                              </TableCell>
                            ...
                            <TableRow>
                              <TableCell>3</TableCell>
                              <TableCell>
                                Force password reset for all users after migration (optional but recommended)
                              </TableCell>
                              <TableCell>
                            ...
                            <TableRow>
                              <TableCell>4</TableCell>
                              <TableCell>
                                Update security policy to prohibit using deprecated cryptographic algorithms
                              </TableCell>
                              <TableCell>
                                <Badge className="bg-yellow-500">Medium</Badge>
                              </TableCell>
                          ...
                          <>
                            ...
                            <TableRow>
                              <TableCell>3</TableCell>
                              <TableCell>
                                Implement runtime secrets injection rather than build-time inclusion
                              </TableCell>
                              <TableCell>
                                <Badge className="bg-amber-500">High</Badge>
                              </TableCell>
                          ...
                          <>
                            ...
                            <TableRow>
                              <TableCell>2</TableCell>
                              <TableCell>
                                Test application functionality after the update in a staging environment
                              </TableCell>
                              <TableCell>
                                <Badge className="bg-amber-500">High</Badge>
                              </TableCell>
                    ...
                    {vulnerability.name === "Expired Certificate" ? (
                      <>
                        ...
                        <div className="text-slate-300">
                          ...
                          DAYS=30
                          <br />
                          EXPIRY=$(openssl s_client -connect $DOMAIN:443 &lt; /dev/null 2&gt;/dev/null | openssl x509
                          ...
                          then
                          <br />
                          &nbsp;&nbsp;echo "Certificate for $DOMAIN will expire in $DIFF days" | mail -s "Certificate
            ...
            <CardFooter className="flex justify-between">
              <Button variant="outline">Copy Code Example</Button>
        ...
        <div className="space-y-6">
            ...
            <CardContent>
              <div className="space-y-4">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span>
                    {new Date(
                      new Date(vulnerability.detected).getTime() + 7 * 24 * 60 * 60 * 1000,
                    ).toLocaleDateString()}
                  </span>
                </div>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Get help with this vulnerability</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="border border-slate-200 dark:border-slate-800 rounded-lg p-4 mb-4 bg-blue-50 dark:bg-blue-900/20">
                <p className="text-sm text-blue-800 dark:text-blue-300">
                  How can I help you remediate this {vulnerability.severity} {vulnerability.name.toLowerCase()}{" "}
                  vulnerability?
                </p>
              </div>
