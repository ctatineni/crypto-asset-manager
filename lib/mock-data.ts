...
export const languages = [
  {
    ...
    vulnerabilities: 2,
    description: "Primary language for web frontend development",
    apps_using: ["app-1", "app-2", "app-3", "app-5"],
  },
  {
    id: "lang-2",
    name: "Python",
    ...
    support_status: "Active",
    vulnerabilities: 1,
    description: "General-purpose language used for backend services and data analysis",
    apps_using: ["app-2", "app-4"],
  },
  {
    id: "lang-3",
    ...
    support_status: "Active",
    vulnerabilities: 3,
    description: "Enterprise-grade language for backend systems",
  ...
  },
  {
    ...
    support_status: "Active",
    vulnerabilities: 1,
    description: "Efficient language for cloud-native applications",
    apps_using: ["app-4"],
  },
  {
    id: "lang-8",
    ...
    vulnerabilities: 2,
    description: "Dynamic language focused on developer productivity",
    apps_using: ["app-2"],
  },
  {
    id: "lang-9",
  ...
  },
  {
    ...
    support_status: "EOL",
    vulnerabilities: 6,
    description: "Legacy Python version with security vulnerabilities",
    apps_using: ["app-5"],
  },
  {
    id: "lang-11",
    ...
    apps_using: ["app-1", "app-4"],
  },
  {
    id: "lang-12",
    name: "SQL",
    type: "Database",
    version: "ANSI SQL:2016",
    latest_version: "ANSI SQL:2019",
    support_status: "Active",
    vulnerabilities: 0,
    description: "Standard language for database queries",
    apps_using: ["app-1", "app-2", "app-3", "app-4", "app-5"],
  },
]
